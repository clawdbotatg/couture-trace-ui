  ...
  return (
    <div className="registers">
      ...
      <div className="flag-badges">
        <span className={`badge ${flags.zero  ? 'badge-coral' : 'badge-dim'}`}>ZERO  {flags.zero  ? 'ON' : 'OFF'}</span>
        <span className={`badge ${flags.carry ? 'badge-coral' : 'badge-dim'}`}>CARRY {flags.carry ? 'ON' : 'OFF'}</span>
        <span className={`badge ${flags.halt  ? 'badge-coral' : 'badge-dim'}`}>HALT  {flags.halt  ? 'ON' : 'OFF'}</span>
      </div>
